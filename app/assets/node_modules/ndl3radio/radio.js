...
var CONFIG_PORT = typpo.get_const('NDL3_CONFIG_PORT');
var FAST_PORT = typpo.get_const('NDL3_FAST_PORT');
...
var Radio = function(address, serportObj) {
  ...
  this._tick = setInterval(send_L2.bind(this), SEND_INTERVAL);
  console.log('calling setInterval', this._tick);
...
function check_L3() {
  ...
  check_port.apply(this, [FAST_PORT, function (buf) {
    /* jshint validthis: true */
    this.emit('object', ubjson.decode(buf));
  }]);
  ...
  check_port.apply(this, [CONFIG_PORT, function (buf) {
    this.emit('config', buf);
  }]);
}
