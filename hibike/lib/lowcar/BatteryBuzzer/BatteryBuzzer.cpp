  ...
  if(segment_8_run == NORMAL_VOLT_READ)
  {
    ...
    switch(sequence) {
      case 0: disp.write("ALL");
              break;
      case 1: disp.write(v_batt, 2);
              break;
      case 2: disp.write("CEL.1");
              break;
      case 3: disp.write(v_cell1, 2);
              break;
      case 4: disp.write("CEL.2");
              break;
      case 5: disp.write(dv_cell2, 2);
              break;
      case 6: disp.write("CEL.3");
              break;
      case 7: disp.write(dv_cell3, 2);
              break;
    }
    ...
    if(triple_calibration)
    {
      switch(sequence) {
        ...
        case 2: disp.write("CAL.1");
                break;
        case 3: disp.write(calib[0], 3);
                break;
        case 4: disp.write("CAL.2");
                break;
        case 5: disp.write(calib[1], 3);
                break;
        case 6: disp.write("CAL.3");
                break;
        case 7: disp.write(calib[2], 3);
                break;
      }
    ...
    else
    {
      switch(sequence) {
        ...
        case 2: disp.write("CAL");
                break;
        case 3: disp.write(vref_guess, 3);
                break;
      }
...
float BatteryBuzzer::calibrate() //calibrates the device.
...
bool BatteryBuzzer::compute_safety() //returns if i'm safe or not based on the most recent reading.
...
void BatteryBuzzer::update_triple_calibration() //updates the global "calib" array based on EEPROM.
