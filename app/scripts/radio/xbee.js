...
exports.createPacket = function (payload, address) {
  ...
  var xbee_tx_frame = typpo.wrap(typpo.get_type('xbee_tx64_header'), {
  ...
  var xbee_payload = typpo.wrap(typpo.get_type('xbee_payload'), {
    tx64: xbee_tx_frame
  });

  var xbee_packet = typpo.wrap(typpo.get_type('xbee_api_packet'), {
  ...
  var buf = buffer.Buffer(typpo.get_size('xbee_api_packet', true) + payload_length + 1);
